...
export class NotificationController {
  ...
  async getNotifications(
    ...
    return this.notificationService.getNotifications(req.user.tenantId, req.user.userId, {
  ...
  async markAllAsRead(@Request() req: any) {
    return this.notificationService.markAllAsRead(req.user.tenantId, req.user.userId);
  }

  @Delete(':id')
  async deleteNotification(@Request() req: any, @Param('id') id: string) {
    return this.notificationService.deleteNotification(req.user.tenantId, req.user.userId, id);
  }

  @Delete('clear-read')
  async deleteAllRead(@Request() req: any) {
    return this.notificationService.deleteAllRead(req.user.tenantId, req.user.userId);
  }
}
