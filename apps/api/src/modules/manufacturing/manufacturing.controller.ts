...
export class ManufacturingController {
  ...
  // ============================================================================
  // Purchase Invoice Endpoints (vendor bills surfaced as a first-class domain)
  // ============================================================================
  ...
  async getPurchaseInvoices(
    ...
    return this.purchaseInvoices.list(req.user.tenantId, {
      supplierId,
      status,
      startDate,
      endDate,
  ...
  @RequireModule(['manufacturing', 'planning'])
  async getPurchaseInvoice(@Request() req: any, @Param('id', ParseUUIDPipe) id: string) {
    return this.purchaseInvoices.getById(req.user.tenantId, id);
  }
  ...
  @Get('gl-accounts')
  @Roles('ADMIN', 'FINANCE', 'PLANNER')
  @RequireModule(['manufacturing', 'reports'])
  async getGLAccounts(
    @Request() req: any,
