...
export class CostingEngineService {
  ...
  private static readonly COST_PROFILE_ALLOWED_FIELDS = {
    costingMethod: 'enum',
  ...
  async getCostProfiles(
    ...
    return applyGridQuery<any>(this.prisma.itemCostProfile, filters, {
      baseWhere: {
        tenantId,
        ...(filters?.productId && { productId: filters.productId }),
        ...(filters?.locationId && { locationId: filters.locationId }),
      },
      allowedFields: CostingEngineService.COST_PROFILE_ALLOWED_FIELDS,
