...
export class QualityService {
  ...
  private static readonly INSPECTION_PLAN_ALLOWED_FIELDS = {
    name: 'string',
    description: 'string',
    inspectionType: 'enum',
    isActive: 'boolean',
    samplingProcedure: 'enum',
    sampleSize: 'number',
    createdAt: 'date',
  } as const;
  ...
  async getInspectionPlans(
    ...
    return applyGridQuery<any>(this.prisma.inspectionPlan, filters, {
      baseWhere: {
        tenantId,
      ...
      allowedFields: QualityService.INSPECTION_PLAN_ALLOWED_FIELDS,
  ...
  private static readonly NCR_ALLOWED_FIELDS = {
    ncrNumber: 'string',
    title: 'string',
    description: 'string',
    type: 'enum',
  ...
  async getNCRs(
    ...
    return applyGridQuery<any>(this.prisma.nonConformanceReport, filters, {
      baseWhere: {
        tenantId,
      ...
      allowedFields: QualityService.NCR_ALLOWED_FIELDS,
      defaultOrderBy: { createdAt: 'desc' },
      include: {
        product: true,
        inspection: true,
  ...
  private static readonly CAPA_ALLOWED_FIELDS = {
    capaNumber: 'string',
    title: 'string',
    description: 'string',
    type: 'enum',
  ...
  async getCAPAs(
    ...
    return applyGridQuery<any>(this.prisma.correctiveAction, filters, {
      baseWhere: {
        tenantId,
        ...(filters?.status && { status: filters.status }),
        ...(filters?.ncrId && { ncrId: filters.ncrId }),
      },
      allowedFields: QualityService.CAPA_ALLOWED_FIELDS,
      defaultOrderBy: { createdAt: 'desc' },
      include: {
