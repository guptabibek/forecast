...
export class ReportsController {
  constructor(
    ...
    private readonly reportsManagementService: ReportsManagementService,
  ...
  async getSummaryReport(@CurrentUser() user: any) {
    return this.reportsManagementService.generateSummaryReport(user.tenantId);
  }
  ...
  @Get('supplier-performance/:supplierKey/purchase-orders')
  @Roles('ADMIN', 'PLANNER', 'FINANCE', 'VIEWER')
  @ApiOperation({ summary: 'Get purchase orders behind a supplier performance row' })
  @ApiResponse({ status: 200, description: 'Supplier purchase-order drill-down retrieved' })
  ...
  @Get('supplier-performance/:supplierKey/purchase-invoices')
  @Roles('ADMIN', 'PLANNER', 'FINANCE', 'VIEWER')
  @ApiOperation({ summary: 'Get purchase invoices behind a supplier performance row' })
  @ApiResponse({ status: 200, description: 'Supplier purchase-invoice drill-down retrieved' })
  ...
  async getReports(@CurrentUser() user: any) {
    return this.reportsManagementService.getReports(user.tenantId);
  }
  ...
  async createReport(
    ...
    return this.reportsManagementService.createReport(user.tenantId, dto, user);
  }
  ...
  async getReport(
    ...
    return this.reportsManagementService.getReportById(user.tenantId, id);
  }
  ...
  async getReportData(
    ...
    return this.reportsManagementService.getReportData(user.tenantId, id);
  }
  ...
  async updateReport(
    ...
    return this.reportsManagementService.updateReport(user.tenantId, id, dto);
  }
  ...
  async deleteReport(
    ...
    return this.reportsManagementService.deleteReport(user.tenantId, id);
  }
  ...
  async generateVarianceReport(
    ...
    return this.reportsManagementService.generateVarianceReport(user.tenantId, dto);
  }
  ...
  async generateTrendReport(
    ...
    return this.reportsManagementService.generateDimensionReport(user.tenantId, { ...dto, type: 'trend' } as any);
  }
  ...
  async generateComparisonReport(
    ...
    return this.reportsManagementService.generateDimensionReport(user.tenantId, { ...dto, type: 'comparison' } as any);
  }
  ...
  async generateAccuracyReport(
    ...
    return this.reportsManagementService.generateDimensionReport(user.tenantId, { ...dto, type: 'accuracy' } as any);
  }
  ...
  async generateDimensionReport(
    ...
    return this.reportsManagementService.generateDimensionReport(user.tenantId, dto);
  }
  ...
  async saveReport(
    ...
    return this.reportsManagementService.saveReport(dto, user);
  }
  ...
  async exportReport(
    ...
    return this.reportsManagementService.exportReport(dto, user);
  }
  ...
  async scheduleReport(
    ...
    return this.reportsManagementService.scheduleReport(dto, user);
  }
}
