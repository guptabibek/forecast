...
export class CreateMargConfigDto {
  ...
  @ApiPropertyOptional({
    description:
      'Which Marg metric becomes inventory_levels.on_hand_qty. STOCK = Marg API current physical (default). OPENING = start-of-fiscal-year balance shown by Marg ERP F8. COMPUTED = Opening + Σ ledger movements.',
    default: 'STOCK',
