...
export const purchaseOrderService = {
  async getAll(params?: {
    ...
    sortDir?: 'asc' | 'desc';
    filters?: string;
  }): Promise<{ items: PurchaseOrder[]; total: number; page: number; pageSize: number; totalPages: number } | PurchaseOrder[]> {
...
export const workOrderService = {
  async getAll(params?: {
    ...
    sortDir?: 'asc' | 'desc';
    filters?: string;
  }): Promise<{ items: WorkOrder[]; total: number; page: number; pageSize: number; totalPages: number } | WorkOrder[]> {
