...
export interface Supplier {
  ...
  /** Some endpoints return both `email` (DB column) and `contactEmail` (legacy alias) — keep both. */
  email?: string | null;
  ...
  /** Free-form JSON populated by Marg sync: margCid, margCompanyId, gstn, route, area, pin, dlNo, etc. */
