...
const rules: PrefetchRule[] = [
  ...
  },
  {
    ...
    loaders: [() => import('@pages/reports/Reports'), () => import('@pages/reports/AiReporting')],
  },
  {
    key: 'pharma-reports',
    match: (path) => path.startsWith('/pharma-reports'),
    loaders: [() => import('@pages/pharma-reports/PharmaReportsRoutes')],
  },
  {
    key: 'settings',
