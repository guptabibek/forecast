...
const navigation: NavigationItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'GL Accounts', href: '/manufacturing/gl-accounts', icon: CurrencyDollarIcon },
      { name: 'Journal Entries', href: '/manufacturing/journal-entries', icon: DocumentTextIcon },
      { name: 'Trial Balance', href: '/manufacturing/trial-balance', icon: TableCellsIcon },
