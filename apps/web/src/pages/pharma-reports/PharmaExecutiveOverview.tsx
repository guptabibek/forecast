...
export default function PharmaExecutiveOverview() {
  ...
  return (
    <section className="space-y-4 lg:space-y-6">
      <div className="rounded-2xl border border-primary-200/60 bg-gradient-to-r from-primary-50 via-white to-amber-50 p-4 lg:p-5 dark:border-primary-900/60 dark:from-secondary-950 dark:via-secondary-900 dark:to-secondary-950">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
          <div className="max-w-3xl">
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-primary-700 dark:text-primary-300">
              Pharma Operations
      ...
      <div className="grid grid-cols-2 gap-3 lg:gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <KpiCard
