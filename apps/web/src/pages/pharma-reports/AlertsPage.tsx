...
export default function AlertsPage() {
  ...
  const { data: alerts, isLoading, isError, error, refetch, isFetching } = usePharmaAlerts({ alertLimit: 500 });
  ...
  const pdfPayload = usePdfPayload({
    ...
    columns: pdfColumns,
    data: pdfData,
    filters: { alertLimit: 500, alertType: filterType, severity: filterSev },
  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <h1 className="text-xl lg:text-2xl font-bold text-gray-900">Inventory Alerts</h1>
        ...
        <ExportToolbar
          ...
          hasActiveViewState={filterType !== 'ALL' || filterSev !== 'ALL'}
        />
      </div>
