            ...
            <DetailPopupActions
              ...
              tables={billDetail.data?.lines?.length ? [{
                ...
                columns: [
                  ...
                  { key: 'expiry', header: 'Expiry', excludeFromPdf: true },
                  { key: 'warehouse', header: 'Warehouse', excludeFromPdf: true },
                  { key: 'quantity', header: 'Qty', align: 'right' as const },
                  { key: 'free_quantity', header: 'Free', align: 'right' as const, excludeFromPdf: true },
                  { key: 'uom', header: 'UOM', excludeFromPdf: true },
                  { key: 'rate', header: 'Rate', align: 'right' as const },
                  { key: 'gross_amount', header: 'Gross', align: 'right' as const, excludeFromPdf: true },
                  { key: 'discount_pct', header: 'Disc %', align: 'right' as const, excludeFromPdf: true },
                  { key: 'discount_amount', header: 'Disc Amt', align: 'right' as const },
                  { key: 'tax_pct', header: 'Tax %', align: 'right' as const, excludeFromPdf: true },
                  { key: 'tax_amount', header: 'Tax', align: 'right' as const },
                  { key: 'cost_rate', header: kind === 'sales' ? 'Cost Rate' : 'Landed Cost', align: 'right' as const, excludeFromPdf: true },
                  { key: 'profit', header: 'Profit', align: 'right' as const, excludeFromPdf: true },
                  { key: 'margin_pct', header: 'Margin %', align: 'right' as const, excludeFromPdf: true },
