  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-xl lg:text-2xl font-bold">Forecast Dashboard</h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          <p className="text-xl lg:text-2xl font-bold">{formatIndianNumber(summary.totalRuns)}</p>
        ...
        >
          ...
          <p className="text-xl lg:text-2xl font-bold">{formatIndianNumber(summary.totalForecasts ?? 0)}</p>
          <p className="text-xs text-secondary-500 mt-1">
            {formatInr(summary.totalForecastValue ?? 0)} total value
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-xl lg:text-2xl font-bold">{summary.modelsUsed.length}</p>
          <p className="text-xs text-secondary-500 mt-1">
