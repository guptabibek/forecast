    ...
    <div className="space-y-4 lg:space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          ...
          <div className="flex items-center gap-3">
            <h1 className="text-xl lg:text-2xl font-bold">Forecast Details</h1>
            {forecast.isOverride && (
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <MetricCard
          ...
          value={formatInr(forecast.forecastAmount)}
        />
        {forecast.forecastQuantity && (
          <MetricCard
            label="Forecast Quantity"
            value={formatIndianNumber(forecast.forecastQuantity, 2)}
            suffix=" units"
          />
        )}
        {forecast.confidenceLower && forecast.confidenceUpper && (
          <>
            <MetricCard
              label="Lower Bound"
              value={formatInr(forecast.confidenceLower)}
            />
            <MetricCard
              label="Upper Bound"
              value={formatInr(forecast.confidenceUpper)}
            />
          </>
        )}
        {forecast.isOverride && forecast.originalAmount && (
          <MetricCard
            ...
            value={formatInr(forecast.originalAmount)}
          />
        )}
      </div>
