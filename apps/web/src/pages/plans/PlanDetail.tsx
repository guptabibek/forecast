    ...
    <div className="space-y-4 lg:space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          ...
          <h1 className="text-xl lg:text-2xl font-bold">{plan.name}</h1>
                      ...
                      forecasts.map((forecast) => (
                        <tr key={forecast.id}>
                          ...
                          <td className="text-right font-mono">
                            {formatInr(forecast.forecastAmount)}
                          </td>
                          <td className="text-right font-mono">
                            {forecast.forecastQuantity ? formatIndianNumber(forecast.forecastQuantity) : '-'}
                          </td>
                          <td className="text-right text-xs text-secondary-500">
                            {forecast.confidenceLower && forecast.confidenceUpper
                              ? `${formatInr(forecast.confidenceLower)} - ${formatInr(forecast.confidenceUpper)}`
                              : '-'}
                          </td>
                          <td>
                            <div className="flex items-center gap-2">
