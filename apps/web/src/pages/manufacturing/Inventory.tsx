  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      <div className="flex justify-between items-start">
        ...
        {/* View-only mode: Transfer + Adjust intentionally disabled. */}
      ...
      <div className="grid grid-cols-4 gap-4">
        <Card>
          <div className="p-4">
            ...
            <div className="text-xl lg:text-2xl font-bold">{levels.length}</div>
          </div>
        </Card>
        <Card>
          <div className="p-4">
        ...
        <Card>
          <div className="p-4">
            ...
            <div className="text-xl lg:text-2xl font-bold">{transactions.length}</div>
          </div>
        </Card>
      </div>
