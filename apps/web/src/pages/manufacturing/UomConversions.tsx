...
export default function UomConversionsPage() {
  ...
  const confirmAction1 = useConfirmAction({
    ...
    message: "Delete this UOM conversion?",
    variant: 'danger',
  });
  ...
  const { data, isLoading, isError, error, refetch } = useQuery({
    queryKey: ['manufacturing', 'uom-conversions', grid.queryKey],
    queryFn: () => uomConversionService.getAll(grid.queryParams),
  ...
  const columns: Column<UnitOfMeasureConversion>[] = [
    {
      ...
      sortable: true, filterType: 'text', filterField: 'fromUom',
    },
    {
      ...
      sortable: true, filterType: 'text', filterField: 'toUom',
    },
    { key: 'factor', header: 'Factor', accessor: (r) => Number(r.factor).toFixed(8), align: 'right', sortable: true, filterType: 'number', filterField: 'factor' },
    {
    ...
    { key: 'createdAt', header: 'Created', accessor: (r) => safeFormat(r.createdAt, 'MMM dd, yyyy'), sortable: true, filterType: 'date', filterField: 'createdAt' },
    {
  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      <div className="flex justify-between items-start">
        <div>
          <h1 className="text-xl lg:text-2xl font-bold">UOM Conversions</h1>
