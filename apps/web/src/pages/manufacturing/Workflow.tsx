...
export default function WorkflowPage() {
  ...
  const templateColumns: Column<WorkflowTemplate>[] = [
    ...
    { key: 'threshold', header: 'Threshold', accessor: (r) => r.thresholdAmount ? formatInr(r.thresholdAmount) : '—', align: 'right' },
  ...
  const instanceColumns: Column<WorkflowInstance>[] = [
    ...
    { key: 'amount', header: 'Amount', accessor: (r) => r.totalAmount ? formatInr(r.totalAmount) : '—', align: 'right' },
    {
      key: 'status', header: 'Status',
  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      <div className="flex justify-between items-start">
        <div>
          <h1 className="text-xl lg:text-2xl font-bold">Workflow & Approvals</h1>
      ...
      {metrics && (
        <div className="grid grid-cols-4 gap-4">
          {[
            ...
            <Card key={i}><div className="p-4 text-center"><div className="text-xl lg:text-2xl font-bold">{m.val}</div><div className="text-xs text-gray-500">{m.label}</div></div></Card>
          ))}
        </div>
      )}
        ...
        {selectedTemplate && (
          <div className="space-y-4 lg:space-y-6">
            <div className="grid grid-cols-3 gap-4 text-sm">
              ...
              <div><span className="font-medium text-gray-500">Threshold:</span> {selectedTemplate.thresholdAmount ? formatInr(selectedTemplate.thresholdAmount) : '—'}</div>
        ...
        {selectedInstance && (
          <div className="space-y-4 lg:space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4 text-sm">
              ...
              <div><span className="font-medium text-gray-500">Amount:</span> {selectedInstance.totalAmount ? formatInr(selectedInstance.totalAmount) : '—'}</div>
